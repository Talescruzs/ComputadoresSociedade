-- Schema para Sistema de Gerenciamento de Transporte Público
...
CREATE INDEX idx_viagem_onibus ON viagem(id_onibus);
CREATE INDEX idx_viagem_linha ON viagem(id_linha);
CREATE INDEX idx_rota_linha ON rota(id_linha);
CREATE INDEX idx_registro_viagem ON registro_lotacao(id_viagem);
CREATE INDEX idx_registro_data ON registro_lotacao(data_hora);
